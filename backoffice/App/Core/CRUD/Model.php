...
class Model {
    ...
    */
    ...
    private function formatWhereCriteria($where_criteria, $prepare_mode = true){
        if(!isset($where_criteria) || !$where_criteria) return "";
        if( !isset($where_criteria["where"]) && ( isset($where_criteria["sort"]) || isset($where_criteria["limit"]) || isset($where_criteria["skip"]) ) ) return "";
        $where_clause = "WHERE";
