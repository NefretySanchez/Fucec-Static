...
class Noticia extends Model {
    ...
    public static function updateNewsById($datap) {
        $fields_array = array(
            ...
            array("field" => "categoria", "value" => $datap[4], "type" => "STR"),
            array("field" => "contenido", "value" => $datap[5], "type" => "STR")
        );
    ...
    public static function createNews($dataNews){
        $fields_array = array(
            ...
            array("field" => "categoria", "value" => $dataNews[3], "type" => "STR"),
            array("field" => "contenido", "value" => $dataNews[4], "type" => "STR"),
            array("field" => "fecha_publicacion", "value" => $dataNews[5], "type" => "STR")
        );
